...
def beta_sheet(original_book, targetnumber):
    ...
    for i in range(2, original_sheet.max_row + 1):
        ...
        for cell in main_headers:
            ...
            if cell in original_headers:
                ...
                if A_party:
                    lat = original_sheet.cell(row=i, column=original_headers[
                        "Originating Party Start Location Latitude"]).value
                    lon = original_sheet.cell(row=i, column=original_headers[
                        "Originating Party Start Location Longitude"]).value
                else:
                    lat = original_sheet.cell(row=i, column=original_headers[
                        "Terminating Party Start Location Latitude"]).value
                    lon = original_sheet.cell(row=i, column=original_headers[
                        "Terminating Party Start Location Longitude"]).value
